 ...
 *
 * A specialized toast notification system for displaying errors.
 * Provides context and hooks for showing error, warning, and network error messages.
 * Uses CSS variables for theming and supports dark mode.
 *
 * @module specialized/ErrorToast
 *
 * @example
 * ```tsx
 * import { ErrorToastProvider, useErrorToast } from '@/components/specialized/ErrorToast';
 *
 * function App() {
 *   return (
 *     <ErrorToastProvider>
 ...
 *   const { showError, dismissError } = useErrorToast();
 *
 ...
 *
 *   useEffect(() => {
 *     const handleOnline = () => showNetworkError(true);
 *     const handleOffline = () => showNetworkError(false);
 *
