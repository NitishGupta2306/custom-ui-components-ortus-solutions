 ...
 *
 * An animated splash screen component with automatic and manual dismissal.
 * Displays branding with smooth animations using Framer Motion.
 * Uses CSS variables for theming and supports dark mode.
 *
 * Note: This component requires framer-motion to be installed.
 *
 * @module animations/SplashScreen
 *
 * @example
 * ```tsx
  ...
  return (
    <AnimatePresence mode="wait">
      <motion.div
        ...
        className="fixed inset-0 z-50 flex items-center justify-center bg-gradient-to-br from-primary via-primary/90 to-secondary cursor-pointer"
      >
        <motion.div
